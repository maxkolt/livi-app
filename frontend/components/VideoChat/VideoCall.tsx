...
const VideoCall: React.FC<Props> = ({ route }) => {
  ...
  const applyAudioOnlyUiState = useCallback((
    ...
    const audioRoute = resolveRouteForAudioOnlyUi(!!opts?.fromPiP);
  ...
  }, [pip, syncPeerVideoInviteHint, resolveRouteForAudioOnlyUi]);
