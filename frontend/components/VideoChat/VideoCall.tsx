...
import { dispatchLeaveVideoCallScreen } from '../../utils/appNavigationGuard';
...
const VideoCall: React.FC<Props> = ({ route }) => {
  ...
  }, [applyVideoCallUiFromPiPExpand, enableLocalCameraForVideoUi, navigation, pinVideoUiSpeakerAndSyncAudio]);
